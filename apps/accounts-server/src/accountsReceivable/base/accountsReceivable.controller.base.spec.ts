...
const service = {
  ...
  accountsReceivables: () => FIND_MANY_RESULT,
  accountsReceivable: ({ where }: { where: { id: string } }) => {
    switch (where.id) {
      case existingId:
...
describe("AccountsReceivable", () => {
  ...
  test("POST /accountsReceivables", async () => {
  ...
  test("GET /accountsReceivables", async () => {
    await request(app.getHttpServer())
  ...
  test("GET /accountsReceivables/:id non existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/accountsReceivables"}/${nonExistingId}`)
  ...
  test("GET /accountsReceivables/:id existing", async () => {
    await request(app.getHttpServer())
      .get(`${"/accountsReceivables"}/${existingId}`)
      .expect(HttpStatus.OK)
      .expect({
        ...FIND_ONE_RESULT,
  ...
  test("POST /accountsReceivables existing resource", async () => {
